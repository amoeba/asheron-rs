...
pub fn read_item<T: ACDataType>(reader: &mut dyn Read) -> Result<T, Box<dyn Error>> {
    T::read(reader)
}
...
pub fn read_u8(reader: &mut dyn Read) -> Result<u8, Box<dyn Error>> {
    let mut buf = [0u8; 1];
...
pub fn read_i8(reader: &mut dyn Read) -> Result<i8, Box<dyn Error>> {
    let mut buf = [0u8; 1];
    reader.read_exact(&mut buf)?;
...
pub fn read_u16(reader: &mut dyn Read) -> Result<u16, Box<dyn Error>> {
    let mut buf = [0u8; 2];
    reader.read_exact(&mut buf)?;
...
pub fn read_i16(reader: &mut dyn Read) -> Result<i16, Box<dyn Error>> {
    let mut buf = [0u8; 2];
    reader.read_exact(&mut buf)?;
...
pub fn read_u32(reader: &mut dyn Read) -> Result<u32, Box<dyn Error>> {
    let mut buf = [0u8; 4];
    reader.read_exact(&mut buf)?;
...
pub fn read_i32(reader: &mut dyn Read) -> Result<i32, Box<dyn Error>> {
    let mut buf = [0u8; 4];
    reader.read_exact(&mut buf)?;
...
pub fn read_u64(reader: &mut dyn Read) -> Result<u64, Box<dyn Error>> {
    let mut buf = [0u8; 8];
    reader.read_exact(&mut buf)?;
...
pub fn read_i64(reader: &mut dyn Read) -> Result<i64, Box<dyn Error>> {
    let mut buf = [0u8; 8];
    reader.read_exact(&mut buf)?;
...
pub fn read_f32(reader: &mut dyn Read) -> Result<f32, Box<dyn Error>> {
    let mut buf = [0u8; 4];
    reader.read_exact(&mut buf)?;
...
pub fn read_f64(reader: &mut dyn Read) -> Result<f64, Box<dyn Error>> {
    let mut buf = [0u8; 8];
    reader.read_exact(&mut buf)?;
...
pub fn read_bool(reader: &mut dyn Read) -> Result<bool, Box<dyn Error>> {
...
pub fn read_string(reader: &mut dyn Read) -> Result<String, Box<dyn Error>> {
...
pub fn read_object_id(reader: &mut dyn Read) -> Result<u32, Box<dyn Error>> {
    read_u32(reader)
}
...
pub fn read_wstring(reader: &mut dyn Read) -> Result<String, Box<dyn Error>> {
...
pub fn read_string32l(reader: &mut dyn Read, pad: bool) -> Result<String, Box<dyn Error>> {
...
pub fn read_packed_word(reader: &mut dyn Read) -> Result<i16, Box<dyn Error>> {
...
pub fn read_u16_be(reader: &mut dyn Read) -> Result<u16, Box<dyn Error>> {
    let mut buf = [0u8; 2];
    reader.read_exact(&mut buf)?;
...
pub fn read_list_with<T>(
    reader: &mut dyn Read,
    mut read_element: impl FnMut(&mut dyn Read) -> Result<T, Box<dyn Error>>,
...
pub fn read_list<T: ACDataType>(reader: &mut dyn Read) -> Result<Vec<T>, Box<dyn Error>> {
    let count = read_u32(reader)? as usize;
    let mut list = Vec::with_capacity(count);
    for _ in 0..count {
...
pub fn read_packable_hash_table_with<K, V>(
    reader: &mut dyn Read,
    mut read_key: impl FnMut(&mut dyn Read) -> Result<K, Box<dyn Error>>,
    mut read_value: impl FnMut(&mut dyn Read) -> Result<V, Box<dyn Error>>,
